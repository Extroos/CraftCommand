                ...
                <div className="bg-[#09090b]/40 backdrop-blur-sm border border-[rgb(var(--color-border-subtle))] rounded-xl p-6 relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-6 border-b border-[rgb(var(--color-border-subtle))] pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-[rgb(var(--color-fg-secondary))]">Status Webhooks</h2>
                                <p className="text-[9px] text-[rgb(var(--color-fg-subtle))] font-medium tracking-wide">Legacy event logging</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                             <div className={`px-2 py-0.5 rounded text-[9px] font-bold border uppercase tracking-wider ${webhookConfig.enabled ? 'bg-emerald-500/5 text-emerald-500 border-emerald-500/20' : 'bg-zinc-800/50 text-[rgb(var(--color-fg-subtle))] border-[rgb(var(--color-border-subtle))]'}`}>
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-[9px] font-bold text-[rgb(var(--color-fg-muted))] uppercase tracking-[0.2em] group-hover:text-[rgb(var(--color-fg-muted))] transition-colors">Webhook URL</label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[9px] font-bold text-[rgb(var(--color-fg-muted))] uppercase tracking-[0.2em]">Bot Name</label>
                                <input 
                                    type="text" 
                            ...
                            <div>
                                <label className="text-[9px] font-bold text-[rgb(var(--color-fg-muted))] uppercase tracking-[0.2em]">Avatar URL</label>
                                <input 
                                    type="text" 
                                    className="w-full bg-[#18181b]/50 border border-[rgb(var(--color-border-subtle))] rounded-md px-3 py-2 text-xs font-medium text-[rgb(var(--color-fg-secondary))] mt-1.5 focus:outline-none focus:ring-1 focus:ring-[#5865F2]/50 focus:border-[#5865F2]/50 transition-colors hover:border-[rgb(var(--color-border-default))]"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 h-full font-sans animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <div className="bg-[#09090b]/40 backdrop-blur-sm border border-[rgb(var(--color-border-subtle))] rounded-xl p-6 relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-6 relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-[rgb(var(--color-fg-secondary))]">Discord Gateway</h2>
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    <span className="text-[9px] font-bold uppercase tracking-widest text-[rgb(var(--color-fg-muted))]">
                        ...
                        {discordStatus.status === 'online' && discordStatus.user ? (
                            <div className="flex items-center gap-4 p-4 rounded-lg bg-[#18181b]/50 border border-[rgb(var(--color-border-subtle))] group/profile hover:bg-[#18181b] transition-colors">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className="text-[8px] text-[rgb(var(--color-fg-subtle))] font-mono bg-[#09090b] px-1.5 py-0.5 rounded border border-[rgb(var(--color-border-subtle))]">v10 Gateway</span>
                                </div>
                            </div>
                        ) : (
            ...
            <div className="space-y-6">
                <div className="bg-[#09090b]/40 backdrop-blur-sm border border-[rgb(var(--color-border-subtle))] rounded-xl p-6 relative overflow-hidden group">
                    ...
                    <div className="space-y-6">
                             <div>
                            <label className="text-[9px] font-bold text-[rgb(var(--color-fg-muted))] uppercase tracking-[0.2em] block mb-1.5">Authorized Role IDs (CSV)</label>
                            <input 
                                type="text" 
                                className="w-full bg-[#18181b]/50 border border-[rgb(var(--color-border-subtle))] rounded-md px-3 py-2 text-xs font-mono text-[rgb(var(--color-fg-secondary))] focus:outline-none focus:ring-1 focus:ring-[#5865F2]/50 focus:border-[#5865F2]/50 transition-colors placeholder:text-zinc-800 hover:border-[rgb(var(--color-border-default))]"
                ...
                <div className="bg-[#09090b]/40 backdrop-blur-sm border border-[rgb(var(--color-border-subtle))] rounded-xl p-6 relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-2 border-b border-[rgb(var(--color-border-subtle))] pb-4 mb-4">
                        ...
                        <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[rgb(var(--color-fg-secondary))]">Slash Command Guide</h3>
                    </div>
