...
const UserProfileView: React.FC = () => {
    ...
    const { user, updatePreferences, theme } = useUser();
    ...
    const handlePasswordChange = async () => {
        ...
        setIsSaving(true);
        try {
            await API.updateUser({ password: passwords.new });
            addToast('success', 'Security Updated', 'Your password has been changed.');
            setPasswords({ current: '', new: '', confirm: '' });
        } catch (e) {
            addToast('error', 'Update Failed', 'Could not update password.');
        } finally {
            setIsSaving(false);
        }
    };
        ...
        <div className="max-w-5xl mx-auto py-8 animate-fade-in pb-20">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 mb-10">
                <div className="relative group">
                    ...
                    {user.minecraftIgn && (
                        <div className={`absolute -bottom-2 left-1/2 -translate-x-1/2 text-white text-[10px] font-bold px-2 py-0.5 rounded-full border border-background shadow-sm whitespace-nowrap ${theme.bg}`}>
                            LINKED
                        </div>
                    )}
                </div>
                        ...
                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                            ...
                            {user.email === 'admin@craftcommand.io' && (
                                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3 items-start">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-amber-500 text-sm">Action Required</h3>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mt-1">
                                            <input 
                                                ...
                                                className="w-full bg-secondary/50 border border-border rounded-lg pl-3 pr-10 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
                                            />
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-secondary/50 border border-border rounded-lg px-3 py-2.5 text-sm mt-1 focus:outline-none focus:ring-1 focus:ring-primary"
                                            />
                                        </div>
                                        <div>
                        ...
                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-3">
                                            {(['emerald', 'blue', 'violet', 'amber', 'rose'] as AccentColor[]).map((color) => (
                                                ...
                                                >
                                                    {user.preferences.accentColor === color && <Check size={16} className="text-white drop-shadow-md" />}
                                                </button>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className={`bg-black p-3 rounded-lg border border-white/10 font-mono text-zinc-400 overflow-hidden h-24 flex flex-col justify-end`} style={{ fontSize: `${user.preferences.terminal.fontSize}px` }}>
                                        ...
                                        <div className="max-w-xs">
                                            ...
                                            <div className="flex gap-2 mt-1.5">
                                                ...
                                                <button 
                                                    ...
                                                    className={`px-4 text-white rounded-lg transition-colors disabled:opacity-50 ${theme.bg} hover:opacity-90`}
                                                >
                    ...
                    {activeTab === 'API' && (
                         <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                            <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
                                ...
                                <div className="bg-[#09090b] border border-border rounded-lg p-4 flex items-center justify-between gap-4 mb-4">
