...
const ServerCard = React.memo(({ server }: { server: ServerConfig }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-[#121214]/60 backdrop-blur-md border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:bg-[#121214]/80 transition-colors shadow-xl group relative overflow-hidden"
        >
            {/* Status Accent Line */}
            ...
            <div className="flex items-start gap-5 flex-1 z-10">
                <div className="relative">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center border transition-colors duration-500 ${
                        isOnline ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-500' : 'bg-zinc-900/50 border-white/5 text-zinc-600'
                    }`}>
                        <Server size={28} />
                    </div>
                    {isOnline && (
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 text-sm text-muted-foreground/60 font-mono">
                        <span className="bg-white/5 px-2 py-0.5 rounded text-zinc-400">{server.software} {server.version}</span>
            ...
            <div className="flex items-center gap-8 w-full md:w-auto border-t md:border-t-0 border-white/5 pt-6 md:pt-0 z-10">
                ...
                <div className="flex items-center gap-6 ml-auto">
                    <div className="text-right">
                        ...
                        <div className="text-xl font-mono font-bold text-white flex items-center gap-2 justify-end">
                            ...
                            <span className={isOnline ? "text-white" : "text-zinc-600"}>{players}</span>
                    ...
                    <button 
                        onClick={handleCopy}
                        className="group/btn relative px-5 py-2.5 bg-zinc-900 hover:bg-zinc-800 border border-white/10 hover:border-emerald-500/50 rounded-xl transition-all active:scale-95"
                    >
        ...
        <div className="min-h-screen bg-[#09090b] text-foreground font-sans selection:bg-emerald-500/20 relative overflow-hidden">
            ...
            <nav className="border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-0 z-50 transition-all duration-300">
                <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <button 
                        ...
                        className="group flex items-center gap-2 px-5 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/20 transition-all text-sm font-medium hover:scale-105 active:scale-95"
                    >
            ...
            <div className="relative z-10 pb-20">
                ...
                <div className="max-w-6xl mx-auto px-6 space-y-4">
                    ...
                    {servers.length === 0 && (
                        <div className="text-center py-24 bg-[#121214]/50 border border-white/5 rounded-2xl animate-fade-in">
            ...
            {/* Footer */}
            <footer className="max-w-6xl mx-auto px-6 py-12 text-center relative z-10 border-t border-white/5">
